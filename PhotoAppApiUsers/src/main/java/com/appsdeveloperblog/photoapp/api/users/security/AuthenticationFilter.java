...
public class AuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	public AuthenticationFilter(UserService userService, Environment environment, AuthenticationManager authenticationManager) {
		...
		super.setAuthenticationManager(authenticationManager);//springin elemanı extend ile supere ekliyoru.
	}
		...
		try {
			...
			return getAuthenticationManager()
					.authenticate(new UsernamePasswordAuthenticationToken(credidentals.getEmail(), 
							credidentals.getPassword(), new ArrayList<>()));//BASE CLASIMIZIN FONKSİYONU
	...
	@Override //authenticaiton bşarılı olduğu zmana döndür
