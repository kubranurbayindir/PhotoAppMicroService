...
import com.appsdeveloperblog.photoapp.api.account.features.accountTypes.queries.getId.GetIdAccountTypesQuery;
...
public class AccountTypesController {
	...
	public String createAccountType(@RequestBody CreateAccountTypeRestModel createAccountTypeRestModel) {
		...
		//2,axon cqrs bus ile yaşam döngüsüne sok
	...
	public AccountTypeListRestModel getById(@RequestParam String accountTypeId) {
		GetIdAccountTypesQuery getIdAccountTypesQuery = new GetIdAccountTypesQuery();
		getIdAccountTypesQuery.setAccountTypeId(accountTypeId);
		AccountTypeListRestModel model = this.queryGateway.query(getIdAccountTypesQuery, 
